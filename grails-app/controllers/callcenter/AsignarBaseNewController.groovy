...
class AsignarBaseNewController {
    ...
    def index() {
        ...
        if (params.consultants && params.dbName && params.tipoRegx && params.allocationNumber) {
            ...
            //def condiciones = [nombreBase: nombreBase, offset: 0, max: params.allocationNumber.toString().toInteger()]
            ...
            if(tipoRegistros.equalsIgnoreCase("SIN GESTION")){
                ...
                sql = "from Clientes where usuario.rol != :rol and nombreBase = :nombreBase and intentos != 0 and plataforma != 'PURE CLOUD' ${condicionEasyDesde} ${condicionEasyHasta} ${condicionIntentosDesde} ${condicionIntentosHasta}  ${condicionSubestado} order by intentos"
            }
