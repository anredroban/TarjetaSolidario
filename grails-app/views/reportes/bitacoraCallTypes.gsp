...
<div class="container-fluid">
    <g:form action = "bitacoraCallTypes"  class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-table"></i> <strong>  Call Types Bases Gestionadas</strong>
            </li>
        </ol>
       ...
       <%-- <div class=" form-group col-lg-4">
        ...
        <div class="form-group col-lg-6">
            ...
            <g:select class="form-control" name="nombreBase" multiple="true" size="10" required="" from="${utilitarios.Util.getNombresBaseCallTypes()}"></g:select>
        </div>
        <div class="col-lg-12">
            <g:submitButton class="btn btn-success" name = "btnEnviar" value = "Generar archivo"></g:submitButton>
        </div>
    </g:form>
</div>