...
<div class="container-fluid">
    <g:form action = "bitacoraSolicitudes"  class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-table"></i> <strong>  Ventas Gestionadas Banco Solidario</strong>
            </li>
        </ol>
       ...
       <%-- <div class="form-group col-lg-6">
        ...
        <div class="col-lg-12">
            <g:submitButton class="btn btn-primary" name = "btnEnviar" value = "Generar archivo"></g:submitButton>
        </div>
    </g:form>
</div>