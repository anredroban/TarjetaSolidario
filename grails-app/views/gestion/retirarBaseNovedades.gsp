...
<head>
    ...
    <title>Tarjetas Solidario - Retirar Novedades</title>
        ...
        <div class="col-lg-12">
            <div class="panel panel-border-orange">
                <div class="panel-heading panel-body-orange">
                    <h3 class="panel-title" style="color:white"><i class="fa fa-users fa-fw"></i> Retirar Novedades</h3>
                </div>
                    ...
                    <div class="table-responsive">
                        <g:form action="retirarBaseNovedades">
                            ...
                            <div class="form-group col-lg-9">
                                ...
                                <g:select class="form-control" name="nombrebase" from="${utilitarios.Util.getNombresBaseNovedades()}" noSelection="${['': 'TODOS']}"></g:select>
                            </div>
                            <div class="form-group col-lg-3">
                                <label></label>
