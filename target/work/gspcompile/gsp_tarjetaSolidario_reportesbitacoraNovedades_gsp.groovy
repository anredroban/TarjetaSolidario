...
class gsp_tarjetaSolidario_reportesbitacoraNovedades_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(3)
invokeTag('textField','g',30,['id':("fechaInicio"),'name':("fechaInicio"),'class':("recall form-control")],-1)
printHtmlPart(4)
invokeTag('textField','g',37,['id':("fechaFin"),'name':("fechaFin"),'class':("recall form-control")],-1)
printHtmlPart(5)
invokeTag('select','g',45,['class':("form-control"),'name':("nombreBase"),'multiple':("true"),'size':("10"),'required':(""),'from':(utilitarios.Util.getNombresBaseNovedades())],-1)
printHtmlPart(6)
invokeTag('submitButton','g',47,['class':("btn btn-primary"),'name':("btnEnviar"),'value':("Generar archivo")],-1)
printHtmlPart(7)
})
invokeTag('form','g',48,['action':("bitacoraNovedades"),'class':("col-lg-12")],1)
printHtmlPart(8)
}
...
public static final long LAST_MODIFIED = 1555952820080L
