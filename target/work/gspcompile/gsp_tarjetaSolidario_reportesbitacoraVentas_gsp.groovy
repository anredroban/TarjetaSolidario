...
class gsp_tarjetaSolidario_reportesbitacoraVentas_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/bitacoraVentas.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(5)
invokeTag('submitButton','g',41,['class':("btn btn-success"),'name':("btnEnviar"),'value':("Generar archivo")],-1)
printHtmlPart(6)
})
invokeTag('form','g',42,['action':("bitacoraVentas"),'class':("col-lg-12")],1)
printHtmlPart(7)
}
...
public static final long LAST_MODIFIED = 1573060765642L
