...
class gsp_tarjetaSolidario_reportesbitacoraPrincipales_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('textField','g',28,['id':("fechaInicio"),'name':("fechaInicio"),'class':("recall form-control")],-1)
printHtmlPart(3)
...
invokeTag('form','g',40,['action':("bitacoraPrincipales"),'class':("col-lg-12")],1)
printHtmlPart(6)
}
...
public static final long LAST_MODIFIED = 1573060719063L
