...
class gsp_tarjetaSolidario_reportesbaseGestionadaNovedades_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/baseGestionadaNovedades.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('select','g',24,['class':("form-control"),'name':("nombreBase"),'multiple':("true"),'size':("10"),'required':(""),'from':(utilitarios.Util.getNombresBaseNovedades())],-1)
printHtmlPart(3)
invokeTag('submitButton','g',26,['class':("btn btn-success"),'name':("btnEnviar"),'value':("Enviar")],-1)
printHtmlPart(4)
})
invokeTag('form','g',26,['action':("baseGestionadaNovedades"),'class':("col-lg-12")],1)
printHtmlPart(5)
}
...
public static final long LAST_MODIFIED = 1558119782905L
