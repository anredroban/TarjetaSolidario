...
class gsp_tarjetaSolidario_reportesbaseGestionada_gsp extends GroovyPage {
...
printHtmlPart(3)
invokeTag('select','g',33,['class':("form-control"),'optionKey':("nombre"),'optionValue':("nombre"),'name':("subestados"),'multiple':("true"),'size':("10"),'required':(""),'from':(callcenter.Subestado.findAllByIsActive(true))],-1)
printHtmlPart(4)
invokeTag('submitButton','g',37,['class':("btn btn-info"),'name':("btnEnviar"),'value':("Generar Excel")],-1)
printHtmlPart(5)
})
invokeTag('form','g',38,['action':("baseGestionada"),'class':("col-lg-12")],1)
printHtmlPart(6)
}
...
public static final long LAST_MODIFIED = 1545860630248L
