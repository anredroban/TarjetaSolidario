...
class gsp_tarjetaSolidario_gestionretirarBaseNovedades_gsp extends GroovyPage {
...
printHtmlPart(9)
invokeTag('select','g',38,['class':("form-control"),'name':("nombrebase"),'from':(utilitarios.Util.getNombresBaseNovedades()),'noSelection':(['': 'TODOS'])],-1)
printHtmlPart(10)
})
invokeTag('form','g',44,['action':("retirarBaseNovedades")],2)
printHtmlPart(11)
...
public static final long LAST_MODIFIED = 1554339307093L
