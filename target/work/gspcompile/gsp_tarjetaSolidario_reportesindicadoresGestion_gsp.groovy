...
class gsp_tarjetaSolidario_reportesindicadoresGestion_gsp extends GroovyPage {
...
printHtmlPart(8)
for( _it478234640 in (tablaResult) ) {
changeItVariable(_it478234640)
printHtmlPart(9)
...
public static final long LAST_MODIFIED = 1566264783421L
