...
class gsp_tarjetaSolidario_reportesbitacoraSolicitudes_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/bitacoraSolicitudes.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(5)
invokeTag('submitButton','g',41,['class':("btn btn-primary"),'name':("btnEnviar"),'value':("Generar archivo")],-1)
printHtmlPart(6)
})
invokeTag('form','g',42,['action':("bitacoraSolicitudes"),'class':("col-lg-12")],1)
printHtmlPart(7)
}
...
public static final long LAST_MODIFIED = 1573060982200L
